...
$sql = "SELECT * FROM job_post ORDER BY createdat DESC LIMIT 6"; // Fetch latest job posts
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $sql1 = "SELECT * FROM company WHERE id_company='{$row['id_company']}'"; // Secure array indexing
...
<!-- "img/photo1.png"  -->
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy;  <a href="https://updategadh.com/">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
